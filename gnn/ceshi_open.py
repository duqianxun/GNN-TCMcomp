...
hidden_channels = search_results.get("Hidden_Channels", 256)
learning_rate = search_results.get("Learning_Rate", 0.001)
epochs = search_results.get("Average_Best_Epoch", 300)
